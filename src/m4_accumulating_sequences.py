...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         ...
         and Billy Davignon.
"""  # Billy Davignon: 1. PUT YOUR NAME IN THE ABOVE LINE.
...
def run_test_make_simple_list():
    ...
    actual = make_simple_list(0, 10)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # Test 3 (add your test here):
    expected = [1, 2]
    actual = make_simple_list(1, 2)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    actual = make_less_simple_string(1, 6)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        ...
        p1 = rg.Point(center.x - radius, center.y - radius)
        p2 = rg.Point(center.x + radius, center.y + radius)
        rectangle = rectangle + [rg.Rectangle(p1, p2)]
    return rectangle
    # -------------------------------------------------------------------------
